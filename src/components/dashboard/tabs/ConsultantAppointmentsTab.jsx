...
function ConsultantAppointmentsTab({ role }) {
  ...
  // First filter by tab (all, upcoming, completed)
  ...
  const nameFilteredAppointments = searchTerm
    ? statusFilteredAppointments.filter((appointment) =>
  ...
  const filteredAppointments = dateFilter
    ? nameFilteredAppointments.filter((appointment) =>
        appointment.date.includes(dateFilter)
      )
    : nameFilteredAppointments;
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="relative w-full md:w-1/3">
          <input
            type="text"
            className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md pl-10 py-2"
        ...
        <div className="w-full md:w-1/3">
          <input
            type="date"
            className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-2 pl-2"
            value={dateFilter}
